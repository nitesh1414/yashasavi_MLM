        ...
        <div class="testi-grid">
            ...
            <div class="testi-card">
                ...
                <div class="testi-who">
                    ...
                    <?php else: ?>
                        <span class="avatar" style="width:46px;height:46px;border-radius:50%;background:var(--green-light);color:#000;display:flex;align-items:center;justify-content:center;font-weight:400"><?= e(strtoupper(substr($t['name'], 0, 1))) ?></span>
                    <?php endif; ?>
